    ...
    g[f] = {
        ...
        settings: {
            ...
            flashError: function() {
                ...
                this.mp3 &&
                    (c +=
                        ' <a href="' + this.mp3 + '">Download audio file</a>.');
            ...
            loadProgress: function(a) {
                h(
                    this.settings.createPlayer.loaderClass,
                    this.wrapper
                ).style.width = Math.round(100 * a) + "%";
            },
            playPause: function() {
                    ...
                    : a.attachEvent &&
                      ...
                      this.memoryLeaking ||
                          (window.attachEvent("onunload", function() {
                              if (this.listeners)
                                  for (
                                      var a = 0, b = this.listeners.length;
                                      a < b;
                                      a++
                                  )
